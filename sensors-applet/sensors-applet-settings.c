...
gboolean sensors_applet_settings_load_sensors (SensorsApplet *sensors_applet) {
    ...
    gchar *current_high_low_alarm_command = NULL;
    gchar *current_high_med_alarm_command = NULL;
    ...
    while (g_variant_iter_loop (iter, GSGVTS, &gsuid)) {
        ...
        sensors_applet_add_sensor(sensors_applet,
            ...
            g_settings_get_double (settings, HIGH_LOW_VALUE),
            g_settings_get_double (settings, HIGH_MED_VALUE),
            ...
            current_high_low_alarm_command = g_settings_get_string (settings, HIGH_LOW_ALARM_COMMAND),
            current_high_med_alarm_command = g_settings_get_string (settings, HIGH_MED_ALARM_COMMAND),
        ...
        g_free (current_high_low_alarm_command);
        g_free (current_high_med_alarm_command);
...
gboolean sensors_applet_settings_save_sensors (SensorsApplet *sensors_applet) {
    ...
    gdouble current_low_value,
            current_high_low_value,
            current_high_med_value,
            current_high_value,
            current_multiplier,
            current_offset;
    ...
    for (not_end_of_interfaces = gtk_tree_model_get_iter_first(GTK_TREE_MODEL(sensors_applet->sensors), &interfaces_iter);
        ...
        for (not_end_of_sensors = gtk_tree_model_iter_children(GTK_TREE_MODEL(sensors_applet->sensors), &sensors_iter, &interfaces_iter);
            ...
            gtk_tree_model_get(GTK_TREE_MODEL(sensors_applet->sensors),
                               ...
                               HIGH_LOW_VALUE_COLUMN, &current_high_low_value,
                               HIGH_MED_VALUE_COLUMN, &current_high_med_value,
                               ALARM_ENABLE_COLUMN, &current_alarm_enable,
                               LOW_ALARM_COMMAND_COLUMN, &current_low_alarm_command,
                               HIGH_LOW_ALARM_COMMAND_COLUMN, &current_high_low_alarm_command,
                               HIGH_MED_ALARM_COMMAND_COLUMN, &current_high_med_alarm_command,
            ...
            g_settings_set_double (settings, HIGH_LOW_VALUE, current_high_low_value);
            g_settings_set_double (settings, HIGH_MED_VALUE, current_high_med_value);
            ...
            g_settings_set_string (settings, HIGH_LOW_ALARM_COMMAND, current_high_low_alarm_command);
            g_settings_set_string (settings, HIGH_MED_ALARM_COMMAND, current_high_med_alarm_command);
